...
def augment(image_batch, mask_batch, dmap_batch):
    ...
    _, mask_aug_batch, dmap_aug_batch = geo_augment(segmentation_maps=mask_batch, heatmaps=dmap_batch)

    return image_aug_batch, mask_aug_batch, dmap_aug_batch
