...
class TestDataset(Dataset):
    def __init__(self, excel_path, image_header, mask_headers, selected_labels, patch_size, pixval_replacement, new_spacing, normalization):
    ...
    def __getitem__(self, index):
        ...
        masks = [read_mask(p, lbs) for p, lbs in zip(self.mask_paths[index], self.selected_labels)]
